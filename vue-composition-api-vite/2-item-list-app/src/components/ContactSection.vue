<template>
    <div>
      <label for="client_name" class="flex flex-col text-gray-400 mb-2">
        ...
        <input autocomplete="off" id="client_name" class="input" type="text" v-model="contact.client_name" />
      </label>
      ...
      <div class="grid grid-cols-3 gap-5">
        ...
        <label for="zip_code" class="flex flex-col text-gray-400 mb-2">
          ...
          <input v-model="contact.zip" autocomplete="off" id="zip_code" class="input" type="text" />
        </label>
